...
export class FasesPage implements OnInit {
  ...
  public fases: Array<fase> = [
    ...
    },
    {
      fase : 'Epoca rebelion',
      link:'/originales',
      imagenfase:'https://i.blogs.es/ed8ee9/darth-vader-obi-wan-fight/1366_2000.jpg',
      sinopsisfase:' Las aventuras de Luke Skywalker desde los desiertos de Tatooine hasta las planicies heladas de Hoth y más allá, en su batalla para liberar la galaxia del malvado emperador Palpatine.'
